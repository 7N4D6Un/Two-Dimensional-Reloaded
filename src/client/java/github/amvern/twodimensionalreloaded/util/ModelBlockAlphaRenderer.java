...
//    public static void renderModelWithAlpha(PoseStack.Pose pose, VertexConsumer vertexConsumer, BlockStateModelPart blockStateModel, float r, float g, float b, float a, int lightCoords, int overlayCoords) {
//        for (BlockStateModelPart blockModelPart : blockStateModel.collectParts(RandomSource.create(42L))) {
